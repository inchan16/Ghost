...
const messages = {
  ...
  globalHelp:
    'Refer to the readme for @tryghost/minifier for how to use this module',
};
  ...
  constructor({ src, dest }) {
    if (!src) {
      throw new errors.IncorrectUsageError({
        message: tpl(messages.missingConstructorOption.message, {
          opt: 'src',
        }),
        context: tpl(messages.missingConstructorOption.context, {
          opt: 'src',
        }),
