...
const setup = (overrides) => {
  const { mockOnActionFn, ...utils } = render(<AccountHomePage />, {
    overrideContext: {
      ...overrides,
    },
  });
...
describe('Account Home Page', () => {
  test('renders', () => {
    ...
    expect(
      utils.queryByText("You're currently not receiving emails")
  ...
  test('can show Manage button for few newsletters', () => {
    ...
    expect(mockOnActionFn).toHaveBeenCalledWith('switchPage', {
