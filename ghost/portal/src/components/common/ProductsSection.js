...
function ProductCardPrice({ product }) {
  ...
  const alternatePrice =
    selectedInterval === 'month' ? yearlyPrice : monthlyPrice;
        ...
        <div className="gh-portal-product-card-pricecontainer">
          <div className="gh-portal-product-card-price-trial">
            <div className="gh-portal-product-price">
              <span
                className={
                  'currency-sign' + (currencySymbol.length > 1 ? ' long' : '')
                }
              >
                {currencySymbol}
              </span>
...
function ProductCards({
  ...
  return products.map((product) => {
    const error = getProductErrorMessage({
      product,
      products,
      selectedInterval,
      errors,
    ...
    <div className="gh-portal-logged-out-form-container">
      ...
      >
        <button
          ...
          className={
            'gh-portal-btn' + (selectedInterval === 'month' ? ' active' : '')
          }
          onClick={(e) => {
        ...
        <button
          ...
          className={
            'gh-portal-btn' + (selectedInterval === 'year' ? ' active' : '')
          }
          onClick={(e) => {
...
export function ChangeProductSection({
  onPlanSelect,
  selectedPlan,
  products,
  type = null,
  ...
  const activeMemberProduct = getProductFromPrice({
    site,
...
function ChangeProductCard({ product, onPlanSelect }) {
  ...
  const { selectedProduct, setSelectedProduct, selectedInterval } =
  ...
  const currentPlan = isMemberActivePrice({
    member,
    site,
