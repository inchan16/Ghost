...
import {
  ...
  transformTierFixture as TransformFixtureTiers,
...
describe('Helpers - ', () => {
  describe('isComplimentaryMember -', () => {
    test('returns true for complimentary member', () => {
      const value = isComplimentaryMember({
  ...
  describe('isActiveOffer -', () => {
    ...
    test('returns false for active offer with archived or disabled tier', () => {
      const value = isActiveOffer({
        offer: FixtureOffer,
        site: FixturesSite.singleTier.onlyFreePlan,
      });
      expect(value).toBe(false);
    });
  });
  ...
  describe('isInviteOnlySite - ', () => {
    test('returns true for invite only site', () => {
      const value = isInviteOnlySite({
        site: FixturesSite.singleTier.inviteOnly,
      });
      expect(value).toBe(true);
    });
  ...
  describe('hasMultipleProducts - ', () => {
    test('returns true for multiple tier site', () => {
      const value = hasMultipleProducts({
        site: FixturesSite.multipleTiers.basic,
      });
      expect(value).toBe(true);
    });
  ...
  describe('transformApiTiersData - ', () => {
    test('can correctly transform tiers data ', () => {
      const transformedTiers = transformApiTiersData({
        tiers: TransformFixtureTiers,
      });
