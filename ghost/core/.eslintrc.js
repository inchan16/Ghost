      ...
      rules: {
        'no-restricted-syntax': [
          ...
          },
          {
            ...
            message:
              'Loop constructs like forEach can perform badly in migrations',
          },
          {
            selector:
              "CallExpression[callee.object.name='_'][callee.property.name='each']",
            message:
              'Loop constructs like _.each can perform badly in migrations',
          },
          {
            selector:
