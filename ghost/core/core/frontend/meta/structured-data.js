...
function getStructuredData(metaData) {
  ...
  structuredData = {
    ...
    'article:publisher': metaData.site.facebook
      ? socialUrls.facebook(metaData.site.facebook)
      : undefined,
    'article:author': metaData.authorFacebook
      ? socialUrls.facebook(metaData.authorFacebook)
      : undefined,
    'twitter:card': card,
    ...
    'twitter:data2': metaData.keywords
