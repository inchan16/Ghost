...
module.exports = function apiRoutes() {
  ...
  router.get(
    '/settings',
    mw.authenticatePublic,
    http(api.publicSettings.browse)
  );
  ...
  router.get(
    '/newsletters',
    mw.authenticatePublic,
    http(api.newslettersPublic.browse)
  );
