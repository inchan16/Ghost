...
module.exports = createTransactionalMigration(
  async function up(knex) {
    ...
    logging.info(
      'Backfilling the members.last_seen_at column from members_login_events.'
    );
    await knex.raw(`
            UPDATE members
  ...
  async function down(knex) {
    ...
    logging.info(
      'Rolling back the backfilling of the members.last_seen_at column from members_login_events.'
    );
