...
module.exports = createTransactionalMigration(
  async function up(knex) {
    const [result] = await knex.count('id', { as: 'total' }).from('products');
    ...
    const nameSettingHasValue = !!(
      productNameSetting && productNameSetting.value
    );
    const name = nameSettingHasValue
      ? productNameSetting.value
      : 'Ghost Subscription';
