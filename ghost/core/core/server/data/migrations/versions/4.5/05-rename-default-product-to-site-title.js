...
module.exports = createTransactionalMigration(
  async function up(connection) {
    ...
    if (!defaultProduct) {
      logging.warn(
        "Skipping rename of default product to site title, default product doesn't exist or already renamed"
      );
      return;
    }
    ...
    if (!siteTitleSetting || !siteTitleSetting.value) {
      logging.warn(
        'Skipping rename of default product to site title, no site title found'
      );
      return;
    }
