...
class UrlService {
  ...
  onRouterUpdated(identifier) {
    const generator = this.urlGenerators.find(
      ...
      objects = _.reduce(
        ...
        (toReturn, object) => {
          if (!toReturn.length) {
            ...
            const i1 = _.findIndex(this.urlGenerators, {
              uid: toReturn[0].generatorId,
            });
            const i2 = _.findIndex(this.urlGenerators, {
              uid: object.generatorId,
            });
  ...
  getPermalinkByUrl(url, options) {
    ...
    const permalink = _.find(this.urlGenerators, {
      uid: object.generatorId,
    }).permalink;
