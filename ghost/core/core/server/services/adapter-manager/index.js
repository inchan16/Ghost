...
adapterManager.registerAdapter(
  'scheduling',
  require('../../adapters/scheduling/SchedulingBase')
);
adapterManager.registerAdapter('sso', require('../../adapters/sso/Base'));
adapterManager.registerAdapter(
  'cache',
  require('@tryghost/adapter-base-cache')
);
...
module.exports = {
  ...
  getAdapter(name) {
    ...
    const { adapterClassName, adapterConfig } = resolveAdapterOptions(
      name,
