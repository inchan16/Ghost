  ...
  const membersApiInstance = MembersApi({
    ...
    mail: {
      ...
      getSubject(type) {
        ...
        switch (type) {
          case 'subscribe':
            return `📫 ${t(`Confirm your subscription to {{siteTitle}}`, {
              siteTitle,
              interpolation: { escapeValue: false },
            })}`;
          case 'signup':
            return `🙌 ${t(`Complete your sign up to {{siteTitle}}!`, {
              siteTitle,
              interpolation: { escapeValue: false },
            })}`;
          case 'signup-paid':
            return `🙌 ${t(`Thank you for signing up to {{siteTitle}}!`, {
              siteTitle,
              interpolation: { escapeValue: false },
            })}`;
          case 'updateEmail':
            return `📫 ${t(`Confirm your email update for {{siteTitle}}!`, {
              siteTitle,
              interpolation: { escapeValue: false },
            })}`;
          case 'signin':
          default:
            return `🔑 ${t(`Secure sign in link for {{siteTitle}}`, {
              siteTitle,
              interpolation: { escapeValue: false },
            })}`;
        }
        ...
        switch (type) {
          case 'subscribe':
            return `
                        ...
                        ${t(
                          ...
                          { siteTitle, interpolation: { escapeValue: false } }
                        )}
          ...
          case 'signup-paid':
            return `
                        ...
                        ${t('Sent to {{email}}', { email })}
                        ${t('Thank you for subscribing to {{siteTitle}}!', {
                          siteTitle,
                          interpolation: { escapeValue: false },
                        })}
                        `;
          case 'updateEmail':
            return `
                        ...
                        ${t(
                          'If you did not make this request, you can simply delete this message.'
                        )} ${t('This email address will not be used.')}
                        `;
          case 'signin':
          default:
            return `
