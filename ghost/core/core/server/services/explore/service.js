  ...
  async fetchData() {
    ...
    const exploreProperties = {
      ...
      stripe: {
        ...
        livemode:
          this.StripeService.api.configured &&
          this.StripeService.api.mode === 'live',
      },
    };

    const mostRecentlyPublishedPost =
      await this.PostsService.stats.getMostRecentlyPublishedPostDate();
    const totalPostsPublished =
      await this.PostsService.stats.getTotalPostsPublished();
    exploreProperties.most_recently_published_at =
      mostRecentlyPublishedPost ?? null;
