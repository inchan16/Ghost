    ...
    {},
    {
      ...
      raw_knex: {
        fetchAll: function (options) {
          ...
          if (shouldHavePosts) {
            plugins.hasPosts.addHasPostsWhere(
          ...
          return query.then((objects) => {
            ...
            if (!withRelated) {
              return _.map(objects, (object) => {
                object = Bookshelf.registry.models[
                  modelName
                ].prototype.toJSON.bind({
                  attributes: object,
                  related: function (key) {
                    return object[key];
                  },
                  serialize:
                    Bookshelf.registry.models[modelName].prototype.serialize,
                  formatsToJSON:
                    Bookshelf.registry.models[modelName].prototype
                      .formatsToJSON,
                })();

                object =
                  Bookshelf.registry.models[modelName].prototype.fixBools(
                    object
                  );
                object =
                  Bookshelf.registry.models[
                    modelName
                  ].prototype.fixDatesWhenFetch(object);
                return object;
              });
            }
            ...
            _.each(withRelated, (withRelatedKey) => {
              ...
              props[relation.name] = (() => {
                ...
                return relationQuery.then((queryRelations) => {
                  ...
                  return queryRelations.reduce((obj, item) => {
                    ...
                    obj[item[relation.whereInKey]].push(
                      _.omit(item, relation.select)
                    );
                    return obj;
                  }, {});
                });
            ...
            return Promise.props(props).then((relationsToAttach) => {
