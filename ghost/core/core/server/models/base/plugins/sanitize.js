  ...
  Bookshelf.Model = Bookshelf.Model.extend(
    {
      ...
      permittedAttributes: function permittedAttributes() {
        return _.keys(schema.tables[this.tableName]).filter(
          (key) => key.indexOf('@@') === -1
        );
      },
    },
    {
      ...
      sanitizeData: function sanitizeData(data) {
        ...
        _.each(data, (value, property) => {
          if (
            ...
            if (isNaN(date)) {
              throw new errors.ValidationError({
                message: tpl(messages.invalidDate, {
                  key: property,
                }),
                code: 'DATE_INVALID',
              });
          ...
          if (
            this.prototype.relationships &&
            this.prototype.relationships.indexOf(property) !== -1
          ) {
            ...
            _.each(relations, (relation, indexInArr) => {
              _.each(relation, (relationValue, relationProperty) => {
                if (
                  ...
                  Object.prototype.hasOwnProperty.call(
                    schema.tables[
                      this.prototype.relationshipBelongsTo[property]
                    ],
                    relationProperty
                  ) &&
                  ...
                  data[property][indexInArr][relationProperty] =
                    moment(relationValue).toDate();
                }
              });
            });
          }
      ...
      filterOptions: function filterOptions(
        ...
        if (
          Object.prototype.hasOwnProperty.call(unfilteredOptions, 'include')
        ) {
        ...
        const extraAllowedProperties =
          filterConfig.extraAllowedProperties || [];
