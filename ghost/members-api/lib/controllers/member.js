  ...
  async updateSubscription(req, res) {
    try {
      ...
      if (
        ...
        ghostPriceId === undefined &&
        smartCancel === undefined &&
        tierId === undefined &&
        cadence === undefined
      ) {
      ...
      if (
        (cancelAtPeriodEnd === undefined || cancelAtPeriodEnd === false) &&
        !smartCancel &&
      ...
      if (tierId && cadence) {
        ...
        const stripePrice = await this._paymentsService.getPriceForTierCadence(
          tier,
          cadence
        );
        ...
        const currentSubscription =
          await this._memberRepository.getSubscription({
            email,
            subscription: {
              subscription_id: subscriptionId,
            },
