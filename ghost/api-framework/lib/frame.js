  ...
  configure(apiConfig) {
    ...
    if (apiConfig.options) {
      ...
      if (Object.prototype.hasOwnProperty.call(this.original, 'query')) {
        Object.assign(
          this.options,
          _.pick(this.original.query, apiConfig.options)
        );
      }
      ...
      if (Object.prototype.hasOwnProperty.call(this.original, 'params')) {
        Object.assign(
          this.options,
          _.pick(this.original.params, apiConfig.options)
        );
      }
      ...
      if (Object.prototype.hasOwnProperty.call(this.original, 'options')) {
        Object.assign(
          this.options,
          _.pick(this.original.options, apiConfig.options)
        );
      }
    }
    ...
    if (this.original.body && Object.keys(this.original.body).length) {
      ...
      if (apiConfig.data) {
        ...
        if (Object.prototype.hasOwnProperty.call(this.original, 'params')) {
          Object.assign(
            this.data,
            _.pick(this.original.params, apiConfig.data)
          );
        }
        ...
        if (Object.prototype.hasOwnProperty.call(this.original, 'options')) {
          Object.assign(
            this.data,
            _.pick(this.original.options, apiConfig.data)
          );
        }
      }
    }
