...
export function kgStyle([style], options) {
  ...
  let cardBorderStyle =
    'pl3 nl3 pr3 nr3 ba b--transparent relative kg-card-hover';

  switch (style) {
    // Card menu
    case 'cardmenu':
      cssClass =
        'koenig-cardmenu absolute top-0 flex flex-column mt0 mr0 mb3 ml0 overflow-y-auto bg-white br3 shadow-3 ttn f7 normal';
      break;
    ...
    case 'cardmenu-label':
      cssClass =
        'f8 lh-heading darkgrey tracked-1 fw4 ma0 ml4 flex-grow-1 truncate';
      break;

    case 'cardmenu-desc':
      cssClass =
        'f-small lh-heading tracked-1 fw4 ma0 ml4 flex-grow-1 midlightgrey truncate';
      break;
    ...
    case 'figcaption':
      cssClass =
        'db pa2 center lh-title sans-serif fw4 f7 middarkgrey tracked-2 tc';
      break;
