...
describe('Unit: Validator: tag-settings', function () {
  ...
  it('validates name presence', function () {
    ...
    expect(nameErrors.message, 'errors.name.message').to.equal(
  ...
  it('validates slug length', function () {
    ...
    expect(slugErrors.message, 'errors.slug.message').to.equal(
      'URL cannot be longer than 191 characters.'
    );
  ...
  it('validates description length', function () {
    ...
    expect(errors.attribute, 'errors.description.attribute').to.equal(
      'description'
    );
    expect(errors.message, 'errors.description.message').to.equal(
  ...
  it('validates metaTitle length', function () {
    ...
    expect(errors.attribute, 'errors.metaTitle.attribute').to.equal(
      'metaTitle'
    );
    expect(errors.message, 'errors.metaTitle.message').to.equal(
      'Meta Title cannot be longer than 300 characters.'
    );
  ...
  it('passes with a valid metaDescription', function () {
    ...
    expect(
      tag.get('metaDescription').length,
    ...
    expect(passed, 'passed').to.be.true;
    expect(tag.get('hasValidated'), 'hasValidated').to.include(
      'metaDescription'
    );
  });
  ...
  it('validates metaDescription length', function () {
    ...
    expect(errors.attribute, 'errors.metaDescription.attribute').to.equal(
      'metaDescription'
    );
    expect(errors.message, 'errors.metaDescription.message').to.equal(
