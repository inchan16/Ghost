...
describe('Acceptance: Settings - Integrations - Unsplash', function () {
  ...
  describe('when logged in', function () {
    ...
    it('it can activate/deactivate', async function () {
      ...
      expect(
        find('[data-test-unsplash-checkbox]').checked,
        'checked by default'
      ).to.be.true;

      await click('[data-test-unsplash-checkbox]');

      expect(find('[data-test-unsplash-checkbox]').checked, 'unsplash checkbox')
        .to.be.false;
      ...
      expect(find('[data-test-unsplash-checkbox]').checked, 'AMP checkbox').to
        .be.true;
    ...
    it('warns when leaving without saving', async function () {
      ...
      expect(currentURL(), 'currentURL after leave without saving').to.equal(
        '/settings/labs'
      );
