...
describe('Acceptance: Settings - Integrations - AMP', function () {
  ...
  describe('when logged in', function () {
    ...
    it('it enables or disables AMP properly and saves it', async function () {
      ...
      expect(find('[data-test-amp-checkbox]').checked, 'AMP checkbox').to.be
        .false;
    ...
    it('warns when leaving without saving', async function () {
      ...
      // AMP is disabled by default
      expect(find('[data-test-amp-checkbox]').checked, 'AMP checkbox default')
        .to.be.false;

      await click('[data-test-amp-checkbox]');

      expect(
        find('[data-test-amp-checkbox]').checked,
        'AMP checkbox after click'
      ).to.be.true;
      ...
      expect(currentURL(), 'currentURL after return').to.equal(
        '/settings/integrations/amp'
      );
