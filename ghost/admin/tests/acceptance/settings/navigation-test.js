...
describe('Acceptance: Settings - Navigation', function () {
  ...
  describe('when logged in', function () {
    ...
    it('saves navigation settings', async function () {
      await visit('/settings/navigation');
      await fillIn(
        '#settings-navigation [data-test-navitem="0"] [data-test-input="label"]',
        'Test'
      );
      await typeIn(
        '#settings-navigation [data-test-navitem="0"] [data-test-input="url"]',
        '/test'
      );
      ...
      expect(navSetting.value).to.equal(
        '[{"label":"Test","url":"/test/"},{"label":"About","url":"/about"}]'
      );
      ...
      expect(
        withText(findAll('[data-test-error]')).length,
    ...
    it('validates new item correctly on save', async function () {
      ...
      await fillIn(
        '#settings-navigation [data-test-navitem="new"] [data-test-input="label"]',
        'Test'
      );
      await fillIn(
        '#settings-navigation [data-test-navitem="new"] [data-test-input="url"]',
        ''
      );
      await typeIn(
        '#settings-navigation [data-test-navitem="new"] [data-test-input="url"]',
      ...
      expect(
        withText(
          findAll(
            '#settings-navigation [data-test-navitem="new"] [data-test-error]'
          )
        ).length,
    ...
    it('clears unsaved settings when navigating away but warns with a confirmation dialog', async function () {
      ...
      expect(
        find('[data-test-navitem="0"] [data-test-input="label"]').value
      ).to.equal('Test');

      await visit('/settings/code-injection');

      expect(
        findAll('[data-test-modal="unsaved-settings"]').length,
        'modal exists'
      ).to.equal(1);
    ...
    it('can add and remove items', async function () {
      ...
      expect(
        find(
          '[data-test-navitem="new"] [data-test-error="label"]'
        ).textContent.trim(),
      ...
      await typeIn(
        '[data-test-navitem="new"] [data-test-input="label"]',
        'New'
      );
      ...
      expect(
        find(
          '[data-test-navitem="new"] [data-test-error="url"]'
        ).textContent.trim(),
      ...
      await click(
        '#settings-navigation [data-test-navitem="0"] .gh-blognav-delete'
      );
      ...
      expect(navSetting.value).to.equal(
        '[{"label":"About","url":"/about"},{"label":"New","url":"/new/"}]'
      );
    });
    ...
    it('can also add and remove items from seconday nav', async function () {
      ...
      expect(
        find(
          '#secondary-navigation [data-test-navitem="new"] [data-test-error="label"]'
        ).textContent.trim(),
        'blank label has validation error'
      ).to.not.be.empty;

      await fillIn(
        '#secondary-navigation [data-test-navitem="new"] [data-test-input="label"]',
        ''
      );
      await typeIn(
        '#secondary-navigation [data-test-navitem="new"] [data-test-input="label"]',
      ...
      await fillIn(
        '#secondary-navigation [data-test-navitem="new"] [data-test-input="url"]',
        ''
      );
      await typeIn(
        '#secondary-navigation [data-test-navitem="new"] [data-test-input="url"]',
      ...
      expect(
        find(
          '#secondary-navigation [data-test-navitem="new"] [data-test-error="url"]'
        ).textContent.trim(),
        'url validation is visible after typing'
      ).to.be.empty;
      ...
      expect(
        withText(
          findAll('#secondary-navigation [data-test-navitem] [data-test-error]')
        ).length,
        'number or validation errors shown after successful add'
      ).to.equal(0);
      ...
      await click(
        '#secondary-navigation [data-test-navitem="0"] .gh-blognav-delete'
      );
