...
describe('Integration: Helper: activity-feed-fetcher-test', function () {
  ...
  it('can fetch events', async function () {
    this.server.createList('member-activity-event', 10, {
      createdAt: moment('2022-11-01 12:00:00').format('YYYY-MM-DD HH:mm:ss'),
    });
  ...
  it('can update total/shown amount of events ', async function () {
    this.server.createList('member-activity-event', 5, {
      createdAt: moment('2022-11-01 12:00:00').format('YYYY-MM-DD HH:mm:ss'),
    });
  ...
  it('can update data for each page', async function () {
    ...
    this.server.create('member-activity-event', {
      createdAt: moment().add(1, 'd').format('YYYY-MM-DD HH:mm:ss'),
    });
