...
export default class PostsController extends Controller {
  ...
  get selectedType() {
    return (
      this.availableTypes.findBy('value', this.type) || {
        value: '!unknown',
      }
    );
  }
  ...
  get selectedVisibility() {
    return (
      this.availableVisibilities.findBy('value', this.visibility) || {
        value: '!unknown',
      }
    );
  }
  ...
  get selectedOrder() {
    return (
      this.availableOrders.findBy('value', this.order) || {
        value: '!unknown',
      }
    );
  }
  ...
  get availableTags() {
    const tags = this._availableTags
      ...
      .sort((tagA, tagB) =>
        tagA.name.localeCompare(tagB.name, undefined, {
