...
export default class NavigationController extends Controller {
  ...
  @tracked newSecondaryNavItem = NavigationItem.create({
    isNew: true,
    isSecondary: true,
  });
  ...
  deleteNavItem(item) {
    ...
    let navItems = item.isSecondary
      ? this.settings.secondaryNavigation
  ...
  reset() {
    ...
    this.newSecondaryNavItem = NavigationItem.create({
      isNew: true,
      isSecondary: true,
    });
  }
  ...
  *saveTask() {
    ...
    if (!this.newSecondaryNavItem.get('isBlank')) {
      validationPromises.pushObject(
        this.send('addNavItem', this.newSecondaryNavItem)
      );
    }
