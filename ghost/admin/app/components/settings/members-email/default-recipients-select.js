    ...
    return [
      {
        ...
        description:
          'Free posts to everyone, premium posts sent to paid members',
        value: 'visibility',
        icon: 'members-post',
        icon_color: 'green',
      },
      {
        name: 'All members',
        description:
          'Everyone who is subscribed to newsletter updates, whether free or paid members',
        value: 'all-members',
        icon: 'members-all',
        icon_color: 'blue',
      },
      ...
      },
      {
        name: 'Usually nobody',
        description:
          'Newsletters are off for new posts, but can be enabled when needed',
        value: 'none',
        icon: 'no-members',
