...
export default class GhNavitemUrlInput extends TextField {
  ...
  notifyUrlChanged() {
    ...
    let isRelativeToBasePath =
      urlURI.getPath() && urlURI.getPath().indexOf(baseURI.getPath()) === 0;
    ...
    let isOnSameHost =
      urlHost === baseHost || (!urlHost && isRelativeToBasePath);
