...
export default class TagForm extends Component {
  ...
  get seoTitle() {
    ...
    const tagName = settingsTitle
      ? `${this.args.tag.name} - ${settingsTitle}`
      : this.args.tag.name;
  ...
  get seoDescription() {
    ...
    metaDescription =
      metaDescription.length > 0 ? metaDescription : this.args.tag.description;
  ...
  get twitterDescription() {
    return (
      this.args.tag.twitterDescription ||
      this.seoDescription ||
      this.settings.metaDescription ||
      ''
    );
  }
  ...
  get facebookDescription() {
    return (
      this.args.tag.facebookDescription ||
      this.seoDescription ||
      this.settings.metaDescription ||
      ''
    );
