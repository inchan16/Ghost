...
const ALL_EVENT_TYPES = [
  ...
  { event: 'login_event', icon: 'filter-dropdown-logins', name: 'Logins' },
  {
    ...
    icon: 'filter-dropdown-paid-subscriptions',
    name: 'Paid subscriptions',
  },
  {
    event: 'payment_event',
    icon: 'filter-dropdown-payments',
    name: 'Payments',
  },
  {
    event: 'newsletter_event',
    icon: 'filter-dropdown-email-subscriptions',
    name: 'Email subscriptions',
  },
  {
    event: 'email_opened_event',
    icon: 'filter-dropdown-email-opened',
    name: 'Email opens',
  },
  {
    event: 'email_delivered_event',
    icon: 'filter-dropdown-email-received',
    name: 'Email deliveries',
  },
  {
    event: 'email_failed_event',
    icon: 'filter-dropdown-email-bounced',
    name: 'Email failures',
  },
];
...
const ALL_EVENT_TYPES_SUPPRESSION = [
  {
    event: 'signup_event',
    icon: 'filter-dropdown-signups',
    name: 'Signups',
    group: 'auth',
  },
  {
    event: 'login_event',
    icon: 'filter-dropdown-logins',
    name: 'Logins',
    group: 'auth',
  },
  {
  ...
  },
  {
    ...
    icon: 'filter-dropdown-email-flagged-as-spam',
...
export default class MembersActivityEventTypeFilter extends Component {
  ...
  get availableEventTypes() {
    ...
    const extended = this.feature.suppressionList
      ? [...ALL_EVENT_TYPES_SUPPRESSION]
      : [...ALL_EVENT_TYPES];

    if (this.settings.commentsEnabled !== 'off') {
      extended.push({
        event: 'comment_event',
        icon: 'filter-dropdown-comments',
        name: 'Comments',
        group: 'others',
      });
    }
    ...
    if (this.settings.emailTrackClicks) {
      extended.push({
        event: 'click_event',
        icon: 'filter-dropdown-clicked-in-email',
