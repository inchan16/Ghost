...
export default class PublishModalComponent extends Component {
  ...
  @tracked emailErrorMessage = this.args.data.publishOptions.post.didEmailFail
    ? this.args.data.publishOptions.post.email.error
    : undefined;
  ...
  *fetchPostCountTask() {
    ...
    if (
      publishOptions.post.isPage ||
      publishOptions.isScheduled ||
      !publishOptions.willPublish
    ) {
      this.postCount = null;
      return;
    }
