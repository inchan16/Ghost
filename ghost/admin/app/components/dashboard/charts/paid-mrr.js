...
export default class PaidMrr extends Component {
  ...
  get chartOptions() {
    const that = this;
    const barColor = this.feature.nightShift
        ...
        callbacks: {
          label: (tooltipItems, data) => {
            ...
            document.querySelector(
              '#gh-dashboard-mrr-tooltip .gh-dashboard-tooltip-value .value'
            ).innerHTML = value;
          },
          title: (tooltipItems) => {
            const value = moment(tooltipItems[0].xLabel).format(DATE_FORMAT);
            document.querySelector(
              '#gh-dashboard-mrr-tooltip .gh-dashboard-tooltip-label'
            ).innerHTML = value;
          },
        },
      },
  ...
  get emptyData() {
    return {
      ...
      data: [
        0, 1500, 4000, 5000, 9000, 11500, 22500, 26000, 30000, 30000, 31000,
        33000, 33500, 35500, 36500, 36500, 40000, 40500, 43500, 47000, 49000,
        49500, 50000, 50000, 53000, 56000, 58000, 61000, 63500, 63500,
      ],
    };
  }
