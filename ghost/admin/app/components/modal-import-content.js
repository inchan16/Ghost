...
export default ModalComponent.extend({
  ...
  _uploadError(error) {
    ...
    if (getErrorCode(error) === 'INVALID_ZIP_FILE_NAME_ENCODING') {
      message =
        'The uploaded zip could not be read due to a long or invalid file name. Please remove any special characters from the file name, or alternatively try another archiving tool if using MacOS Archive Utility.';
