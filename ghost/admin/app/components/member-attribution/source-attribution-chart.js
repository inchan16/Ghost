...
export default class SourceAttributionChart extends Component {
  ...
  get chartOptions() {
    ...
    return {
      ...
      title: {
        ...
        padding: 12,
        fontFamily:
          'Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Droid Sans,Helvetica Neue,sans-serif',
        color: '#7c8b9a',
        fontSize: 12,
        fontStyle: '600',
      },
      ...
      tooltips: {
        ...
        custom: function (tooltip) {
          ...
          const tooltipEl = document.getElementById(
            'gh-dashboard-attribution-tooltip'
          );
        ...
        callbacks: {
          label: (tooltipItems, data) => {
            const tooltipTextEl = document.querySelector(
              '#gh-dashboard-attribution-tooltip .gh-dashboard-tooltip-value'
            );
  ...
  get chartData() {
    ...
    return {
      ...
      datasets: [
        {
          label:
            this.args.sortColumn === 'signups' ? 'Signups' : 'Paid conversions',
  ...
  get others() {
    ...
    return this.sortedSources.slice(5).reduce(
      (acc, source) => {
        return {
          ...acc,
