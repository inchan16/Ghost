...
export default class NotificationsService extends Service {
  ...
  handleNotification(message, delayed = false) {
    const wordRegex = /[a-z]+/gim;
    const wordMatches = (message.message.string || message.message).matchAll(
      wordRegex
    );
    ...
    if (
      message.constructor.modelName === 'notification' &&
    ...
    this.content = new TrackedArray(
      this.content.reject((notification) => {
